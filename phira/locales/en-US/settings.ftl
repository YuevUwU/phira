...
item-fullscreen-sub = Switch to full-screen for a better experience.
item-multitouch = Multitouch mode
item-multitouch-sub = Enable multitouch support and disable mouse input during gameplay.
