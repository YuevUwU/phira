...
batch-import-confirm = Batch import data detected. Import { $count } charts?
batch-import-success = Successfully imported { $count } charts
...
deeplink-opening = Opening chart...
deeplink-open-failed = Failed to open the chart
