# general
unknown-note-type = Тодорхойгүй нотын төрөл: { $type }
json-parse-failed = JSON-г задлахад амжилтгүй боллоо
...
hitsound-missing = `{ $name }` хитсаунд алга байна
# pgr
event-not-contiguous = Үйл явдлууд дараалсан байх ёстой
alpha-events-parse-failed = Альфагийн үйл явдлуудыг задлахад амжилтгүй боллоо
rotate-events-parse-failed = Эргэлдэх үйл явдлуудыг задлахад амжилтгүй боллоо
move-events-parse-failed = Хөдлөх үйл явдлуудыг задлахад амжилтгүй боллоо
# pec
unexpected-eol = Мөрийн төгсгөл гэнэтийн байна
expected-f32 = f32 байх ёстой байсан
expected-usize = usize байх ёстой байсан
expected-tween = tween байх ёстой байсан
...
expected-01 = 0 / 1 (жинхэнэ нот / хуурамч нот) байх ёстой байсан
unexpected-extra = Гэнэтийн илүү контент: { $next }
line-location = Мөр дээр #{ $lid }
# extra
